      ...
      <div className="scene" id="welcome">
        <article className="content">
          <div className="gallery">
            <img src="images/intro_room.jpg" alt="Intro Gallery Room Sample Pictures"/>
            <img src="images/intro_pool.jpg" alt="Intro Gallery Pool Sample Pictures"/>
            <img src="images/intro_dining.jpg" alt="Intro Gallery Dining Sample Pictures"/>
            <img src="images/intro_attractions.jpg" alt="Intro Gallery Attractions Sample Pictures"/>
            <img className="hidesm" src="images/intro_wedding.jpg" alt="Intro Gallery Dining Sample Pictures"/>
          </div>
